...
class HREmployee(models.Model):
    ...
    # CHANGED: Using language_master instead of res.lang
    mother_tongue_id = fields.Many2one('language_master', string="Mother Tongue")
    ...
    def _create_azure_email(self):
        ...
        try:
            ...
            while count < 100:
                ...
                if existing_in_odoo:
                    _logger.warning(f"⚠️ {unique_email} exists in Odoo ({existing_in_odoo.name})")
                    count += 1
    ...
    def _add_to_dept_dl(self):
        ...
        try:
            ...
            if check_response.status_code == 200:
                ...
                _logger.info(f"ℹ️ User not in DL, will add now")
            else:
